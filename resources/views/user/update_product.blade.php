    ...
    <div class="col-sm-6 col-md-4 col-lg-4" style="margin: auto; width: 50%; padding: 30px;">
        <div class="box">
            ...
            <div class="detail-box">
                ...
                <form action="{{url('update_cart_product_quantity', $cart_product->id)}}" method="post">
                    ...
                    <div class="row">
                        ...
                        @else
                            <div class="col-md-4">
                                <input width="100px;" type="number" name="quantity" value="{{$cart_product->quantity}}" min="1" max="{{$product->quantity}}">
                            </div>
                            <div class="col-md-3">
